...
<br>
<center><h3 class="form-title"><span id="testCodeception" ><font color="ffffff">Coderlaba | </font><font color="FF6633">Сброс</font></h3></center>

<div class="content">
	<form style="login-form" class="form-vertical" >	<h3 class="">Забыли пароль?</h3>
	<p>Введите свой email для восстановления пароля.</p>
		<div class="control-group  "><div class="controls"><div class="input-icon left"><i class="icon-user"></i><input placeholder="Email" class="m-wrap placeholder-no-fix" type="text" name="lostname" /></div></div></div>

	<center><img src="/engine/modules/antibot.php" alt="Включите эту картинку для отображения кода безопасности" border="0" onclick="CaptchaReload(); return false;" width="150" height="100" /></center>
	<br>
	<div class="control-group  "><div class="controls"><div class="input-icon left"><i class="icon-ok"></i><input placeholder="Ответ" class="m-wrap placeholder-no-fix" type="text" name="sec_code" id="sec_code" value="" /></div></div></div>								
		
		<div class="fieldsubmit">
	<div class="form-actions">
		<a href="/login" id="back-btn" class="btn">
			<i class="m-icon-swapleft"></i> Назад
		</a>
	
			<button type="submit" name="submit" class="btn green pull-right">
			Сбросить <i class="m-icon-swapright m-icon-white"></i>
		</button></div>
	</div>
</form></div>
